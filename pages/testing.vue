      ...
      <div class="-mx-1 -mb-1">
        <div class="flex flex-wrap -mb-8" style="margin-bottom: -30px">
          <template v-for="day in days">
            <div class="px-2 py-2 w-[14.28%]">
              <div
                v-text="day"
                class="text-gray-600 text-sm uppercase tracking-wide font-bold text-left mb-1"
              ></div>
            </div>
          </template>
        </div>
        ...
        <div class="flex flex-wrap border-t border-l">
          <template v-for="emptyDay in emptyDays">
            <div
              class="text-left border-r border-b px-4 pt-2 h-32 w-[14.28%]"
            ></div>
          </template>
...
export default {
  ...
  data() {
    return {
      ...
      events: [
        {
          event_date: new Date(2022, 9, 4),
          event_title: "My Birthday :)",
          event_theme: "red",
        },
        {
          event_date: new Date(2022, 11, 25),
        ...
        {
          event_date: new Date(2022, 11, 31),
